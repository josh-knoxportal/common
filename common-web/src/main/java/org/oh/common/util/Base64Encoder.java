...
public abstract class Base64Encoder {
	...
	/**
	 * Converts a binary data into a Base64 encoded string. If the binary data is null or a zero-length array, an empty
	 * string is returned.
	 *
	...
	// ==========================================
	/**
	 * Converts a Base64 encoded string into a binary data. If the string is null or an empty string, a zero-length
	 * array is returned.
	 *
	 * @param value A Base64 encoded string to decode. The length of the string must be a multiple of 4. If it is null
	 *            or an empty string, a zero-length array is returned.

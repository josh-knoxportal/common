...
$MAVEN_HOME/bin/mvn install:install-file -Dfile=$COMMON_LIBS/common-web-1.0.jar -DgroupId=com.nemustech.common -DartifactId=common-web -Dversion=1.0 -Dpackaging=jar -DgeneratePom=true

...
@ApiModel(description = "작업  목록 VO")
public class WorkMntVo {
	...
	private String real_starting_date;
	private String real_ending_date;
	private int real_worker_count;
	private String worker_factory_name;
	private String worker_zone_name;
	...
	public String getReal_ending_date() {
		return real_ending_date;
	}

	public void setReal_ending_date(String real_ending_date) {
		this.real_ending_date = real_ending_date;
	}

	public int getReal_worker_count() {
		return real_worker_count;
	}

	public void setReal_worker_count(int real_worker_count) {
		this.real_worker_count = real_worker_count;
	}

	public String getWorker_factory_name() {
		return worker_factory_name;
	}

	public void setWorker_factory_name(String worker_factory_name) {
		this.worker_factory_name = worker_factory_name;
	}

	public String getWorker_zone_name() {
		return worker_zone_name;
	}

	public void setWorker_zone_name(String worker_zone_name) {
		this.worker_zone_name = worker_zone_name;
	}

	public String getReal_starting_date() {
		return real_starting_date;
	}

	public void setReal_starting_date(String real_starting_date) {
		this.real_starting_date = real_starting_date;
	}

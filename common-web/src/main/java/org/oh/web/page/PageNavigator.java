...
public class PageNavigator {
	...
	public static class Builder {
		...
		public Builder(Paging paging) {
			this(paging.getPage_number(), paging.getTotal_sise());
			setRowsPerPage(paging.getRows_per_page());
			setPageGroupCount(paging.getPage_group_count());
		}

		public <T> Builder(Page<T> page) {
		...
		public Builder setPageGroupCount(int pageGroupCount) {
			this.pageGroupCount = pageGroupCount;
			return this;
		};

		public PageNavigator build() {
			return new PageNavigator(this);
		}
	}

	protected PageNavigator(Builder builder) {
		this.pageGroupCount = builder.pageGroupCount;

...
/**
 * {@link org.oh.common.db.dao.DBDao} 인터페이스를 MyBatis 3.0 기반으로 구현한다. <br />
 * DBSqlParameter를 설정할 때는 dsName을 environment id와 동일하게 설정한다.
 * 
 * 
 * @version 1.0.0
 * @see {@link org.oh.common.db.dao.DBDao} <BR />
 *      {@link org.oh.common.db.type.DBSqlParameter}
 * 
 */
public class MyBatisDao implements DBDao {
	...
	/**
	 * {@inheritDoc}
	 * ResultType이 일반 POJO일 경우에는 해당 POJO는 {@link org.oh.common.db.type.DBMap}에 POJO 이름으로 저장한다.
	 */
	...
	/**
	 * {@link java.util.List}객체를 {@link org.oh.common.db.type.DBMapList} 객체로 바꾼다. {@link java.util.List}에 {@link org.oh.common.db.type.DBMap}이 있다면, {@link org.oh.common.db.type.DBMapList}로 바로 변경하며,
	 * 그 외 객체가 있다면, {@link org.oh.common.db.type.DBMap}으로 변경 후에 {@link org.oh.common.db.type.DBMapList}로 변경한다.
	 * 
	 * @param list {@link java.util.List}객체
	 * @return {@link org.oh.common.db.type.DBMapList} 객체
	 */
	@SuppressWarnings("rawtypes")

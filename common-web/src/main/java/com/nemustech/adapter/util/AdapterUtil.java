...
public class AdapterUtil {
	...
	// 프로퍼티 키
	public static final String PROPERTY_IS_REAL = "com.nemustech.adapter.isOnline";
	public static final String PROPERTY_POSTFIX = "com.nemustech.adapter.postfix";
	public static final String PROPERTY_SUPER_PASSWORD = "com.nemustech.adapter.super_password";
	public static final String PROPERTY_SERVER_TYPE = "com.nemustech.adapter.server_type";
	public static final String PROPERTY_SERVER_URL = "com.nemustech.adapter.server_url";
	public static final String PROPERTY_SERVER_PORT = "com.nemustech.adapter.server_port";
	public static final String PROPERTY_SERVER_CONTEXT = "com.nemustech.adapter.server_context";
	public static final String PROPERTY_PUSH_URL = "com.nemustech.adapter.push_url";
	public static final String PROPERTY_PUSH_PORT = "com.nemustech.adapter.push_port";
	public static final String PROPERTY_PUSH_CONTEXT = "com.nemustech.adapter.push_context";
...
//				}
	...
	public static String getDownloadUrl(String trcode, String file_name, List<NameValuePair> params) {
		String url = PropertyUtils.getInstance().getString("com.nemustech.adapter.server_url") + ":"
				+ PropertyUtils.getInstance().getString("com.nemustech.adapter.server_port") + "/"
				+ PropertyUtils.getInstance().getString("com.nemustech.adapter.server_context")

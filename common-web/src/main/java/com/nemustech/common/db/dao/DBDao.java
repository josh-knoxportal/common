package com.nemustech.common.db.dao;
 ...
 * 해당 interface를 구현할 때는 {@link com.nemustech.common.db.type.DBSqlResult}의 내용을 참고한다.
 * 
 * 
 * @version 1.0.0
 * @see com.nemustech.common.db.type.DBSqlResult
 *
 */
public interface DBDao {
	...
	/**
	 * select SQL을 수행한다.
	 * 수행 결과 하나의 ResultSet은 {@link com.nemustech.common.db.type.DBMapList} 또는 {@link com.nemustech.common.db.type.DBMap} 형태로 저장하기를 권장한다.
	 * 
	 * @param sqlParam SQL을 수행하기 위한 정보
	 * @return SQL 수행 결과
	 * @throws SQLException

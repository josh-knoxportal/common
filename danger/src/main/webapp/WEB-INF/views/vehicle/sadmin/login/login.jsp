...
<script type="text/javascript">
	...
	function login(paramObj){
		...
		var url = ngmsUrl + '/vehicle/login.do' ; 
		var method = 'POST';
	...
	function search_id() {
		...
		var url = ngmsUrl + '/vehicle/searchId.do' ; 
		var method = 'POST';
		var headerMap = {"access_token" : "1234test", "request_type" : "2"};
		var paramMap = null;	
		doRestFulApi(url, headerMap, method, data, function(result){
	...
	function reset_password() {
		...
		var url = ngmsUrl + '/vehicle/resetPassword.do' ; 
		var method = 'POST';
		var headerMap = {"access_token" : "1234test", "request_type" : "2"};
		var paramMap = null;	
		doRestFulApi(url, headerMap, method, data, function(result){
			...
			} else if( result.msg === 'NOMATCHNAME') {
	...
	<div id="wrap"><!-- wrap s -->
		<div id="login-wrap"> <!-- login-wrap s -->
			<div id="header">
				<h2 class="login-logo" style="margin-bottom:18px"><img height="65"  src="<c:url value="/resources"/>/img/lg_logo_vlogin.png" alt="차량안전운행"></h2>
			</div>
			<div id="contents"> <!-- contents s -->
				<div class="login-title">
					<h3>관리자 로그인</h3>
					<p>차량안전운행 관리자 사이트에 오신 것을 환영합니다.</p>
				</div>
				<div id="formWrap" class="clearfix"> 
					...
					<div class="right-form"> <!-- right-form s -->
						<p class="blind">차량안전운행</p>
					</div> <!-- right-form e -->
				</div>
			</div> <!-- contents e -->
			<div class="notice">
	...
	<div class="pop-wrap reset-pw-pop"> <!-- reset-pw-pop s -->
		...
		<div class="pop-up"> <!-- pop-up s -->
			...
			<div class="pop-contents"> <!-- pop-contents -->
				<div class="pop-info">
					<p class="pw-text-info">본인 확인 후 임시 비밀 번호를 등록된 메일 주소로 보내드립니다.</p>
				</div>
				...
				<div class="form-wrap prev-box clearfix">
					<form id="pw_form" action="#" class="clearfix">
						<div class="group-box display-table">
							<div class="form-group table-row first-group clearfix">
								<div class="table-cell title-cell">
									<label class="control-label">로그인 ID <span>*</span></label>
								</div>
								<div class="table-cell">
									<div class="input-box">
							...
							<div class="form-group table-row clearfix">
								...
								<div class="table-cell">
									<div class="input-box">
										<input class="form-input pwEnterClass" type="text" name="name" maxlength="50"/>
									</div>
								</div>
							</div>
							<div class="form-group table-row clearfix">
								...
								<div class="table-cell">
									<div class="input-box">
										<input class="form-input pwEnterClass" type="text" id="email" name="email" maxlength="50"/>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="form-wrap next-box clearfix">
					<div class="find-user-id display-table">
						<div class="table-row">
							<div class="table-cell">
								<span class="find-id-info">등록된 메일주소로 비밀번호 재발급이 완료 되었습니다.</span>
							</div>
						</div>
					</div>
					<div class="form-actions text-center">

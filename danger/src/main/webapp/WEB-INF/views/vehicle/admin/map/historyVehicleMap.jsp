...
<script src="<c:url value="/resources/js"/>/priority-queue.js" type="text/javascript"></script>
...
/* [2016/08/19] UPGRADE */
	...
	$(document).ready(function(){
		...
		canvasHistoryVehicleMap.setOnCompletedFactoryCoordListener(function() {
			/* */			
			canvasHistoryVehicleMap.redrawRoadMap();
		});
		
		/* [2016/08/26] added */
		canvasHistoryVehicleMap.setOnCompletedLoadMapListener(function() {
	...
	function makeViolationTableRow(violationHistoryList) {
		...
		for(var idx = 0; idx < size; idx++) {
			...
			if (entry.violation_type == VIOLATION_OVER_SPEED) {
				...
				var anchor = '<a class="hovergray" href="javascript:twinkleViolationSections(\''+entry.begin_section_uid+'\',\''+entry.end_section_uid+'\')">출입<br>제한</a>';
				html += '<td><strong>'+anchor+'</strong></td>';
				html += '<td>';
			}		
				...
				<div class="n_map_wrap">
					...
					<div class="n_map_right">
						<div class="n_map_search">
							...
							<div class="input-box">
								<select id="select_violation_type" class="sel3">

...
# $MAVEN_HOME/bin/mvn install:install-file -Dfile=lib/org/oh/common/sapjco/3/sapjco-3.jar -DgroupId=org.oh.common -DartifactId=sapjco -Dversion=3 -Dpackaging=jar -DgeneratePom=true
# $MAVEN_HOME/bin/mvn install:install-file -Dfile=lib/org/oh/common/rtim-common-crypt/2.6.0.RELEASE/rtim-common-crypt-2.6.0.RELEASE.jar -DgroupId=org.oh.common -DartifactId=rtim-common-crypt -Dversion=2.6.0.RELEASE -Dpackaging=jar -DgeneratePom=true

 ...
 * 
 * @see <a href="http://seed.kisa.or.kr">seed.kisa</a>
 */
public abstract class DigestUtil extends DigestUtils {
	...
	public static String sha256Hex2(String data) throws RuntimeException {
		try {
			byte[] pszDigest = Sha256EncryptB(data.getBytes());
	...
	public static String sha256Hex3(String data) throws RuntimeException {
		try {
			if (SHA_256 == null)
	...
	protected static String getbyteToHexString(byte[] hash) {
...
//		System.out.print("\n\n");
		...
		String s = "1aA가";
		LogUtil.writeLog(sha256Hex(s));
		LogUtil.writeLog(sha256Hex2(s));
		LogUtil.writeLog(sha256Hex3(s));
	}
}
